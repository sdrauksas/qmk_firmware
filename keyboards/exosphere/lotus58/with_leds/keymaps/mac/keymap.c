...
[_QWERTY] = LAYOUT(
      ...
      LCTL_T(G(KC_SPACE)),   KC_Z, 	    KC_X,      KC_C,      KC_V,      KC_B,      KC_VOLD,       KC_VOLU,    KC_N,	 KC_M,      KC_COMM,   KC_DOT,    KC_SLSH,   KC_RCTL,
...
[_SYM] = LAYOUT(
      ...
      _______,   DF(_GAME), RGB_TOG,   RGB_MOD,   RGB_VAD,   CH_LANG,   KC_MPRV,       KC_MNXT,    PR_SCR,	 KC_BSLS,   KC_BTN1,   KC_BTN3,   KC_BTN2,   _______,
