...
[_SYM] = LAYOUT(
    ...
    _______, DF(_GAM),XXXXXXX, XXXXXXX, PR_SCR,  CH_LANG, KC_MPLY,       KC_KB_MUTE,XXXXXXX,KC_PDOT,KC_P0,   KC_PEQL, KC_PPLS, _______,
...
bool rgb_matrix_indicators_kb(void) {
    ...
    switch(get_highest_layer(layer_state | default_layer_state)) {
        ...
        case _SYM:
            ...
            rgb_matrix_set_color_all(red_scaled_rgb.r, red_scaled_rgb.g, red_scaled_rgb.b); // SYM
            break;
        case _NAV:
