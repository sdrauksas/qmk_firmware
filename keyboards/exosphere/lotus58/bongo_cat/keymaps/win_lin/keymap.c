...
[_GAM] = LAYOUT(
    ...
    KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_VOLD,       KC_VOLU, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RGUI,
                               KC_LALT, MO(_SYM),KC_SPC,  KC_ENT,        DF(_QWE),KC_RCTL, MO(_NAV),KC_RALT
),
...
[_SYM] = LAYOUT(
    ...
    _______, DF(_GAM),XXXXXXX, XXXXXXX, KC_PSCR, CH_LANG, _______,       _______, XXXXXXX, KC_PDOT, KC_P0,   KC_PEQL, KC_PPLS, _______,
