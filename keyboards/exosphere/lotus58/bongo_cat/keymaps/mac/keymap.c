...
[_QWE] = LAYOUT(
    ...
    MV_SPAC, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_VOLD,       KC_VOLU, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
                               KC_LALT, MO(_NAV),KC_LGUI, KC_ENT,        KC_SPC,  KC_RGUI, MO(_SYM),KC_RALT
),
...
[_GAM] = LAYOUT(
    ...
    KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_VOLD,       KC_VOLU, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
                               KC_LALT, MO(_NAV),KC_SPC,  KC_ENT,        DF(_QWE),KC_RGUI, MO(_SYM),KC_RALT
),
...
[_SYM] = LAYOUT(
    ...
    _______, DF(_GAM),XXXXXXX, XXXXXXX, XXXXXXX, CH_LANG, _______,       _______, KC_PSCR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
