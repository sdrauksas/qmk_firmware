...
#define MV_SPAC LCTL_T(G(KC_SPACE))
...
[_QWE] = LAYOUT(
    ...
    MV_SPAC, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_VOLD,       KC_VOLU, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
                               KC_LALT, MO(_SYM),KC_LGUI, KC_ENT,        KC_SPC,  KC_RGUI, MO(_NAV),KC_RALT
),
...
[_GAM] = LAYOUT(
    ...
    KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_VOLD,       KC_VOLU, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RCTL,
                               KC_LALT, MO(_SYM),KC_SPC,  KC_ENT,        KC_LGUI, KC_RGUI, MO(_NAV),KC_RALT
),
...
[_COL] = LAYOUT(
    ...
    KC_LGUI, KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_VOLD,       KC_VOLU, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RGUI,
...
[_SYM] = LAYOUT(
    ...
    _______, DF(_GAM),DF(_COL),DF(_QWE),PR_SCR,  CH_LANG, _______,       _______, XXXXXXX, KC_PDOT, KC_P0,   KC_PEQL, KC_PPLS, _______,
                               _______, _______, _______, _______,       _______, _______, _______, _______
),

[_NAV] = LAYOUT(
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPLY,       _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    ...
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV,       KC_MNXT, XXXXXXX, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,
                               _______, _______, _______, _______,       _______, _______, _______, _______
)
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_COL] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(XXXXXXX, XXXXXXX) },
