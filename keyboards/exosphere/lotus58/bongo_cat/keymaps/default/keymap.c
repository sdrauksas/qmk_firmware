...
[_QWE] = LAYOUT(
    ...
    KC_LGUI, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_VOLD,       KC_VOLU, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RGUI,
                               KC_LALT, TG(_NAV),KC_LCTL, KC_ENT,        KC_SPC,  KC_RCTL, TG(_SYM),KC_RALT
),
...
[_GAM] = LAYOUT(
    ...
    KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_VOLD,       KC_VOLU, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RGUI,
                               KC_LALT, TG(_NAV),KC_SPC,  KC_ENT,        DF(_QWE),KC_RCTL, TG(_SYM),KC_RALT
),
...
layer_state_t layer_state_set_user(layer_state_t state) {
   return update_tri_layer_state(state, _SYM, _NAV, _NAV);
}
